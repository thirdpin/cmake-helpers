...
# Use
#
#   common::standard_libraries_nosyscalls
#
# name to link this library to your target
add_library_with_ns(standard_libraries_nosyscalls common)

# Linker options/linked libraries depend on compiler
if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
    target_link_libraries(standard_libraries_nosyscalls INTERFACE
...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    ...
    message(FATAL_ERROR "standard_libraries_nosyscalls target generation failed!\
